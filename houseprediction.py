...
#one hot encoder converts categorical data into binary vectors

# used to convert categorical data into binary vectors

# maps values to integer values

# we are collecitng all the features which have the object datatype
